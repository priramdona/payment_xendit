            ...
            <div class="col-md-5">
                <div class="card shadow border-0 p-5">
                    ...
                    <form action="{{ route('account.authenticate') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="" class="mb-2">Login</label>
                        ...
                        <button class="btn btn-primary mt-2">Masuk</button>
                            <a href="{{ route("account.forgotPassword") }}" class="mt-3">Lupa Sandi?</a>
                        </div>
                    </form>
                </div>
                <div class="mt-4 text-center">
                    <p>Belum punya Akun? <a  href="{{ route('account.registration') }}">Daftar</a></p>
                </div>
            </div>
        </div>
