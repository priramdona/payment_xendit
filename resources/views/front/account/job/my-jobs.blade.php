                                ...
                                <tbody class="border-0">
                                    @if ($jobs->isNotEmpty())
                                        ...
                                        <tr class="active">
                                            ...
                                            <td>{{ $job->applications->count() }} Donatur</td>
                                            <td>
                                                @if ($job->status == 1)
                                                <div class="job-status text-capitalize">Aktif</div>
                                                @else
                                            ...
                                            <td>
                                                {{-- <div class="action-dots float-end">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="{{ route('jobDetail', $job->id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> Lihat</a></li>
